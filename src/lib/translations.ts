export const translations = {
  pt: {
    ...
    synopsis: {
      title: "Sinopse",
      text: "\"NYX-POST-PORN\" é uma obra audiovisual que investiga a relação entre corpo, câmera e estética no contexto do pós-pornô. O filme desconstroi a objetificação do corpo feminino e propõe uma nova abordagem sensorial e ética ao prazer visual. Capturando fragmentos do corpo em performance, o projeto questiona as fronteiras do olhar e oferece uma experiência imersiva de autoconhecimento e expansão corporal, propondo um novo paradigma de espectatorialidade no cinema contemporâneo."
    },
    concept: {
    ...
    filmmakers: {
      ...
      filmmakers: [
        {
          name: "Castro Pizzano",
          role: "Idealização, Dir. de Fotografia, Montagem e Pós-Prod.",
    ...
    references: {
      title: "Referências",
      stateOfArt: "Estado da Arte",
      references: [
        {
          author: "Mulvey, Laura",
          work: "Prazer Visual e Cinema Narrativo",
          description: "A crítica à escopofilia patriarcal e à objetificação do corpo feminino no cinema.",
          relation: "NYX ressignifica o olhar, propondo um prazer visual ético que nasce do corpo expandido e autônomo.",
        ...
        },
        {
          ...
          description: "O vídeo como extensão da performance corporal e dispositivo de captura do corpo em processo.",
          relation: "NYX assume o gesto videoperformático como método artístico e político de resistência.",
        ...
        },
        {
          ...
          description: "Fragmentação corporal e fusão entre orgânico e mecânico na performance audiovisual.",
    ...
    credits: {
      ...
      locationValue: "Curitiba, PR – Brasil",
      program: "Programa",
      ppgCineav: "PPG-CINEAV",
      ppgCineavFull: "Progr. de Pós-Grad. em Cinema e Artes do Vídeo",
      unespar: "UNESPAR",
      unesparFull: "Universidade Estadual do Paraná",
      unesparSub: "Faculdade de Artes do Paraná (FAP)",
      research: "Grupo de Pesquisa CineCriare",
      project: "Projeto Corpo e Movimento no Cinema e nas Artes do Vídeo",
  ...
  en: {
    ...
    references: {
      title: "References",
      stateOfArt: "State of the Art",
      references: [
        {
          author: "Mulvey, Laura",
          work: "Visual Pleasure and Narrative Cinema",
          description: "The critique of patriarchal scopophilia and the objectification of the female body in cinema.",
          relation: "NYX redefines the gaze, proposing ethical visual pleasure from the expanded and autonomous body.",
          pdf: "/documents/mulvey-prazer-visual.pdf"
        },
        {
          author: "Comolli, Jean-Louis",
        ...
        },
        {
          ...
          description: "Video as extension of bodily performance and device for capturing the body in process.",
          relation: "NYX assumes the videoperformative gesture as artistic and political method of resistance.",
          pdf: "/documents/vinhosa-videoperformance.pdf"
        },
        {
          author: "Azevedo, Adriana",
        ...
        },
        {
          author: "Barney, Matthew",
          work: "Hoist (Destricted)",
          description: "Bodily fragmentation and fusion between organic and mechanical in audiovisual performance.",
    ...
    credits: {
      ...
      instagram: "Instagram",
      location: "Location",
      locationValue: "Curitiba, PR – Brazil",
      program: "Program",
      ppgCineav: "PPG-CINEAV",
      ppgCineavFull: "Graduate Prog. in Cinema and Video Arts",
      unespar: "UNESPAR",
      unesparFull: "State University of Paraná",
      unesparSub: "Faculty of Arts of Paraná (FAP)",
      research: "CineCriare Research Group",
      project: "Body and Movement Project in Cinema and Video Arts",
